 ...
 */
 class TestModifierC {
	...
	public static void main(String[] args) {
		//public 접근지정자를 가진 TestModifierA클래스의 변수를 사용해보자
...
//		System.out.println("tma 객체 private " + tma.d ); //접근불가
		
		System.out.println("------------------");
		//package 접근지정자를 가진 TestModifierB클래스의 변수를 사용해보자
...
//		System.out.println("tmb 객체 private " + tmb.d );//접근불가
