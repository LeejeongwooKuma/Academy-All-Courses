...
//		revMsg();
		//thread로 메시지 읽기를 동시에 실행시켜야된다. 
		//Thread와 has a 관계를 설정
	...
	/**
	 * 메시지 읽기( 메시지 보내기와 동시에 실행되어야 한다. Thread와 동시에 동작) : 대화상대가 메시지를 몇건이나 보낼지
	 * 
	 * @throws IOException
	 */
	@Override
	...
	/**
	 * 메시지 보내기 J.T.F에서 이벤트가 발생하면 입력된 메시지를 내 대화창에 올리고, 접속자에게 보낸다.
	 * 
	 * @throws IOException
	 */
	public void sendMsg() throws IOException {
		String sendMsg = "[으ㅓㅓ] :" + jtfTalk.getText().trim();
		if (dosWriteStream != null) {
