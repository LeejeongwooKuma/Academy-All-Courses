 ...
 * 사람의 공통 특징은 부모클래스에서 가져다 사용(코드의 재사용성) 자식클래스는 자신만의 특징(싸움을 잘한다.)을 정의.<br>
 * 사용법)<br>
 * HongGilDong 객체명 = new HongGilDong(); 객체명.자신metod();<br>
...
public class HongGilDong extends Person {
	...
	/**
	 * 싸움레벨은 1~10까지 존재하며 일반인은 3정도의 싸움레벨을 가지고 홍길동은 6정도의 레벨을 가짐.
	 */
	public HongGilDong() {
		level = 6;
	}// HongGilDong
	...
	/**
	 * 싸움을 하는 일, 이기면 레벨이 상승, 지면 레벨 하락, 비기면 레벨 변화 없음.
	 * 
	 ...
	 * 규칙 : 접근지정자는 달라도 되고 반환형, method명 매개변수는는 일치해야 함.
	 */
	@Override
