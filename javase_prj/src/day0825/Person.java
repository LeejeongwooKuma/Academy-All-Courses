...
/**
 * 사람을 대상으로 선정하여 객체 모델링 후 제작한 클래스.<br>
 * 08-22-2025에 모든 사람의 공통특징을 정의한 부모클래스가 됨<br>
 * 08-25-2025에 추상클래스로 전환됨(이유 : 모든 사람이 집에서 먹는 것이 밥이 아니었음)<br>
...
public abstract class Person {
	...
	private int eye, nose, mouth; //눈, 코, 입 개수를 저장할 instance variable
	private String name; // 이름을 저장할 instance variable
	
	/**
	 * 눈 2개, 코 1개, 입 1개인 사람 객체를 생성할 때 사용하는 생성자
	 */
	public Person() {
		this(2, 1, 1); //this는 객체 생성 없이 내 클래스의 다른 생성자를 호출할 때 사용
//		eye = 2;
//		nose = 1;
//		mouth = 1;
	}//Person
	...
	/**
	 * 생성된 사람 객체에서 제공하는 기능으로, 밖에서 밥을 사먹는 일
	 * @param menu 음식메뉴
	 * @param price 음식가격
	 * @return
	 */
