  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				////throws ClassNotFoundException Compile예외를 날림. 원래 자바라면 에러가 떠야하는데 안 뜨는 이유는 java파일 만드는 파일 가보면 java로 만들면서
				//try ~ catch (java.io.IOException e)로 에러를 잡아줌. 
				Class.forName(className); 
				//} 저 위에 있는(java파일로 바꾸는 파일 기준) try가 짝이되어, try 구문이 잘못되었다고 에러가 발생.
				%>	
				정상코드	
				</c:catch>
