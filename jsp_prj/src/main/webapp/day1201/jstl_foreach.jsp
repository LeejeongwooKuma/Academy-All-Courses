  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<c:if test="${i.first }">
				<td colspan="2">데이터를 출력하기 전에 제공할 내용.</td> <!-- 운영자 글을 맨위나 맨 마지막에 보여줄 때 사용하면 좋음. -->
				</c:if>
				...
				<td><input type="text" name="age" value="${ sum+=member.myAge }"/></td>
				...
				<td><strong><c:out value="${totalAge }"/></strong>살</td>
				</tr>
				</c:if>
