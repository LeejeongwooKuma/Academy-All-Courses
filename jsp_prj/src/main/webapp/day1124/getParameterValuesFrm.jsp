...
function postSend() {
	...
	document.frm.submit(); // vJS을 사용한 이동
}//getSend
</script>
...
<div id="wrap">
	...
	<input type="button" value="GET전송" class="btu btn-success" id="btnGet"/>
	<input type="button" value="POST전송" class="btu btn-success" id="btnPost"/>
	</form>
	</div>
