  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<!-- 기본생성자 호출 : 
				scope객체
				page(pageContext) : 페이지가 요청 될 때 마다 객체가 생성되고, 생성된 객체는 현재 페이지에서만 사용된다. 
				request : 페이지가 요청 될 때 마다 객체가 생성되고, 생성된 객체는 현재 페이지와 forward로 이동한 페이지에서 사용가능하다.
				session : 접속자마다(웹 브라우저마다) 하나의 객체가 생성되고, 생성된 객체는 모든 JSP페이지 에서 사용될 수 있다.
				application : 최초 접속자에 의해 하나의 객체가 생성되고, 생성된 객체는 모든 접속자가 공유하여 사용된다.
				 -->
