...
public class CreateDeptXML {
	...
	public void createXml ( List<DeptDTO> list, JspWriter out)throws IOException { //jspwriter쓰면 웹브라우저로 출력할 때 씀.
		//1. XML 문서 객체 생성
		...
		FileOutputStream fos = new FileOutputStream("C:/Users/doraemong/git/Academy-All-Courses/jsp_prj/src/main/webapp/xml1215/deptInfo.xml");
